...
@section('content')
    <div class="content">
        ...
        @endif
        <div class="container">
        <form class="cmxform form-horizontal tasi-form" action="{{ route('elem.offenseadd')}}" method="post">
            {{csrf_field()}}
            <div class="row">
                <div class="col-sm-12">
                                          ...
                                          <div class="panel panel-default">
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10">
                                                    <select size="5" class="select2 form-control" name="persons_involve[]" multiple="multiple" data-placeholder="Please select student" required>
