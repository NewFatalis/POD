<div class="left side-menu">
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                     <li>
                        <a href="{{ url('/elemhome') }}" class="waves-effect"><i class="md md-dashboard"></i><span>Dashboard </span></a>
                    </li>
                    <li>
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="{{url('/elem/adviser')}}"><i class="md md-person-add"></i> Advisers</a></li>
                            <li><a href="{{url('/elem/sanction')}}"><i class="ion-ios7-paper"></i>     Sanctions</a></li>
                        </ul>
                    </li>
                    <li class="has_sub">
