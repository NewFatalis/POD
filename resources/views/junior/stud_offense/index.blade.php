...
@section('content')
    <div class="content">
        ...
        @endif
        <div class="container">
        <form class="cmxform form-horizontal tasi-form" action="{{ route('junior.offenseadd')}}" method="post">
            {{csrf_field()}}
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <div class="panel panel-default">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                        <select size="5" class="select2 form-control" name="persons_involve[]" data-placeholder="Please select student" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <select style="word-wrap: break-word;" size="5" class="select2 form-control" name="" data-placeholder="Please select sanctions" required>
                                                  <option value="#">&nbsp;</option>
                                                  <option value="">1st Sanction - asndmansmdnmasndas</option>
                                                  <option value="">2nd Sanction - asndmansmdnmasndas</option>
                                                  <option value="">Category C - 75 Homerome Grade and 1 day suspension from classes</option>
                                                    <option value="">Category A - With parent</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
