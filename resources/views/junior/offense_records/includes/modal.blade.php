            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select class="select2 form-control" id="" name="" required="required">
                                <option value="">Please select sanction</option>
                                 <option value="">Promissory Note</option>
                                 <option value="">75 Grade</option>
